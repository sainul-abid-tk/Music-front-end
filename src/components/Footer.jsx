  ...
  return (
    ...
    <div className='d-flex justify-content-between container mt-4 ' style={{height:'250px'}}>
      <div style={{width:'350px'}}>
        <h4><i class="fa-solid fa-cloud-arrow-up "></i>&nbsp;Media Player</h4>
      ...
      <div style={{width:'200px'}}>
        <h4>Links</h4>
          <p><Link to={'/'} style={{textDecoration:'none',color:'white'}}>Landing Page</Link></p>
          <p><Link to={'/home'} style={{textDecoration:'none',color:'white'}}>Home</Link></p>
          <p><Link to={'/history'} style={{textDecoration:'none',color:'white'}}>Watch History</Link></p>
      </div>
      <div style={{width:'200px'}}>
        <h4>Guides</h4>
